...
"@
    ...
    <footer style="margin-top: 40px; padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; color: #6c757d; border-top: 3px solid #667eea;">
        ...
        $(if ($IsPartialResults) { 
            ...
            if ($CheckpointData -and $CheckpointData.ExecutionId) { "<p><strong>Original Execution ID:</strong> $($CheckpointData.ExecutionId)</p>" }
            if ($global:executionId -and $global:executionId -ne $CheckpointData.ExecutionId) { "<p><strong>Report Generation ID:</strong> $($global:executionId)</p>" }
        } else {
